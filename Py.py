...
if Side=="Main Page":
    ...
    st.write('')
    st.write("# An Intelligent Web Dashboard for TL Faults Analysis")
...
################################################################# 3rd selection ###################################################### 
    ...
    if st.sidebar.checkbox("Display Labels", False):
        st.sidebar.subheader("Fault/ No Fault Labels:")
        st.sidebar.write(p3)

    classifier = st.sidebar.selectbox("Choose Classifier Model", ("Light Gradient Boosting Machine", "K Neighbors Classifier"))
